...
import { LayoutDashboard, Monitor, Map, BarChart3, Settings, HelpCircle, FileText, ShieldCheck, Image } from 'lucide-react';
...
const Sidebar = () => {
    ...
    const navItems = [
        ...
        // --- NEW CONTENT HUB LINK ---
        { name: 'Content Hub', icon: <Image size={20} />, path: '/content-hub' },
